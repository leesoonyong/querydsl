...
//                .fetch();
//
//        Member fetchO = jpaQueryFactory
//                .selectFrom(member)
//                .fetchOne();
//
//        Member fetchF = jpaQueryFactory
//                .selectFrom(member)
//                .fetchFirst();
    ...
    @Test
    public void paging2(){
        QueryResults<Member> queryResult = jpaQueryFactory
                .selectFrom(member)
                .orderBy(member.username.desc())
                .offset(1)
                .limit(2)
    ...
    public void complexCase(){
        List<String> result = jpaQueryFactory
                .select(new CaseBuilder()
                        ...
                        .when(member.age.between(21, 30)).then("30살")
                        .otherwise("기타")
                ).from(member)
                .fetch();
        for (String s : result) {
    ...
    public void sqlFunction(){
        List<String> result = jpaQueryFactory.select(Expressions.stringTemplate("function('replace',{0},{1},{2})",
